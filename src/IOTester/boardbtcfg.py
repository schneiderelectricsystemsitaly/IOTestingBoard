...
BOARD_SERVICE_UUID = UUID('0013cdd5-0000-1000-8000-00805f9b0131')
BOARD_STATUS_UUID = UUID('0013cdd3-0000-1000-8000-00805f9b0131')
BOARD_COMMAND_UUID = UUID('0013cdd4-0000-1000-8000-00805f9b0131')

BATTERY_SERVICE_UUID = UUID('0000180F-0000-1000-8000-00805F9B34FB')
BATTERY_CHAR_UUID = UUID(0x2A19)

DEVICE_INFORMATION_SERVICE_UUID = UUID('0000180A-0000-1000-8000-00805F9B34FB')
